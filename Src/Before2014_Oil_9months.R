...
sheet_arps <- fillOilSheet_arpsprod(neighborsPool_before2014_oil, final_before2014_oil_test, sheet_oil, 9)
sheet_ml <- fillOilSheet_mlprod(neighborsPool_before2014_oil, final_before2014_oil_test, sheet_arps)


sheet_all <- fillOilSheet(sheet_ml, newdataset_before2014_oil, final_before2014_oil_test, 9, neighborsPool_before2014_oil)

sheet_final <- fillOilError(sheet_all)


sheet_final$FORECAST_NAME <- 9
write.csv(sheet_final, "sheet_final_before2014_oil_9.CSV", row.names = FALSE)